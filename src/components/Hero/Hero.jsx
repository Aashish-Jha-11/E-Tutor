        ...
        <div className="flex flex-col justify-center py-14 md:pr-16 xl:pr-40 md:py-0">
          <div className="text-center md:text-left space-y-6">
            ...
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="text-5xl font-semibold lg:text-6xl !leading-tight dark:text-white"
            >
            ...
            >
              ...
              <button className="flex justify-end items-center gap-2 font-semibold dark:text-white">
                <span className="w-10 h-10 bg-secondary/15 dark:bg-secondary/30 rounded-full flex justify-center items-center">
