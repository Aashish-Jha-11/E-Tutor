...
const WhyChooseUs = () => {
  return (
    <div className="bg-[#f9fafc] dark:bg-gray-800 transition-colors duration-300">
          ...
          {WhyChooseData.map((item) => {
            return (
              <motion.div
                ...
                initial="hidden"
                whileInView={"visible"}
                className="space-y-4 p-6 rounded-xl shadow-[0_0_22px_rgba(0,0,0,0.15)] dark:bg-gray-700 dark:shadow-[0_0_22px_rgba(0,0,0,0.3)]"
              >
                {/* icon section */}
                <div
