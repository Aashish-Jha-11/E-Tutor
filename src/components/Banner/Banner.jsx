...
const Banner = ({ image, title, subtitle, link, tag, reverse }) => {
  return (
    <div className="bg-[#f9f9f9] dark:bg-gray-800 pb-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0">
          ...
          <div className="flex flex-col justify-center text-center md:text-left space-y-4 lg:max-w-[500px]">
            ...
            <motion.p
              ...
              initial="hidden"
              whileInView={"visible"}
              className="text-xl lg:text-2xl font-semibold capitalize dark:text-white"
            >
              {title}
            </motion.p>
            <motion.p
              ...
              initial="hidden"
              whileInView={"visible"}
              className="text-sm text-slate-500 dark:text-gray-300"
            >
              {subtitle}
            </motion.p>
            <motion.div
